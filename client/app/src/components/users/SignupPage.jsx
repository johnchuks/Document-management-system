        ...
        <div className="row">
            ...
            <div className="row">
              <div className="input-field col s12">
                ...
                {errors.fullName && <span className="help-block"
                 style={errorAlert}>{errors.fullName}</span>}
              </div>
            </div>
            <div className="row">
              <div className="input-field col s12">
                ...
                {errors.userName && <span className="help-block"
                 style={errorAlert}>{errors.userName}</span>}
              </div>
            </div>
            <div className="row">
              <div className="input-field col s12">
                ...
                style={errorAlert}>{errors.email}</span>}
              </div>
            </div>
            <div className="row">
              <div className="input-field col s12">
                ...
                style={errorAlert}>{errors.password}</span>}
              </div>
            </div>
            <div className="row">
              <div className="col m6 s12">
                  <a className="waves-effect wave-light btn orange"
                   id="signupButton" type="submit" name="action"
                    onClick={this.onSubmit}>SignUp</a>
            </div>
